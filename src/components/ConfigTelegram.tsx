    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-[var(--c-card)] border border-[var(--c-border)] rounded-2xl p-4 sm:p-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 className="font-display font-700 text-lg text-[var(--c-text)] tracking-wide">ALERTAS TELEGRAM</h2>
      ...
      {/* Paso 1 — Crear bot */}
      <div className="bg-[var(--c-card)] border border-[var(--c-border)] rounded-2xl p-4 sm:p-6 space-y-4">
        <h3 className="font-display font-700 text-[var(--c-text)] tracking-wide flex items-center gap-2">
        ...
        <div className="space-y-3 text-sm text-[var(--c-text-2)]">
          <div className="flex items-start gap-3 bg-[var(--c-inner)] border border-[var(--c-border-sub)] rounded-xl px-4 py-3">
          ...
          <div className="flex items-start gap-3 bg-[var(--c-inner)] border border-[var(--c-border-sub)] rounded-xl px-4 py-3">
            ...
            <div>
              Escríbele <span className="font-mono bg-[var(--c-bg)] px-2 py-0.5 rounded text-amber-400">/newbot</span> y sigue las instrucciones — ponle el nombre que quieras
            </div>
          </div>
          <div className="flex items-start gap-3 bg-[var(--c-inner)] border border-[var(--c-border-sub)] rounded-xl px-4 py-3">
            <span className="text-amber-400 font-mono text-xs mt-0.5 flex-shrink-0">03</span>
            <div>
              BotFather te dará un <span className="text-[var(--c-text)] font-500">token</span> — cópialo y guárdalo
            </div>
          </div>
          <div className="flex items-start gap-3 bg-[var(--c-inner)] border border-[var(--c-border-sub)] rounded-xl px-4 py-3">
            <span className="text-amber-400 font-mono text-xs mt-0.5 flex-shrink-0">04</span>
            <div>
              Busca tu bot recién creado en Telegram y <span className="text-[var(--c-text)] font-500">escríbele cualquier mensaje</span> para activarlo
            </div>
          </div>
          <div className="flex items-start gap-3 bg-[var(--c-inner)] border border-[var(--c-border-sub)] rounded-xl px-4 py-3">
            <span className="text-amber-400 font-mono text-xs mt-0.5 flex-shrink-0">05</span>
            <div className="w-full">
              <p className="mb-2">Abre esta URL en el navegador para obtener tu <span className="text-[var(--c-text)] font-500">chat_id</span>:</p>
              <div className="flex items-center gap-2 bg-[var(--c-bg)] rounded-lg px-3 py-2 overflow-x-auto">
                ...
                <button onClick={() => copiar('https://api.telegram.org/bot<TU_TOKEN>/getUpdates', 'url')}
                  className="flex-shrink-0 text-slate-500 hover:text-[var(--c-text-2)]">
      ...
      <div className="bg-[var(--c-card)] border border-[var(--c-border)] rounded-2xl p-4 sm:p-6 space-y-4">
        ...
        <div className="relative bg-[var(--c-bg)] border border-[var(--c-border-sub)] rounded-xl p-4 overflow-x-auto">
          <button
            ...
            className="absolute top-3 right-3 text-slate-500 hover:text-[var(--c-text-2)] transition-colors"
          >
            {copiado === 'env' ? <Check size={13} className="text-green-400" /> : <Copy size={13} />}
          </button>
          <pre className="font-mono text-xs text-[var(--c-text-2)] leading-relaxed">
...
NEXT_PUBLIC_APP_URL=`}<span className="text-amber-400">https://tu-app.vercel.app</span>
      ...
      <div className="bg-[var(--c-card)] border border-[var(--c-border)] rounded-2xl p-4 sm:p-6 space-y-4">
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-3 rounded-xl border transition-all text-sm ${
                horaSeleccionada === h.cron
                  ...
                  : 'border-[var(--c-border-sub)] text-slate-400 hover:border-slate-600'
              }`}
            >
        ...
        <div className="bg-[var(--c-bg)] border border-[var(--c-border-sub)] rounded-xl p-4 space-y-2">
          ...
          <div className="relative">
            <button
              ...
              className="absolute top-0 right-0 text-slate-500 hover:text-[var(--c-text-2)]"
            >
